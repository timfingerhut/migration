GitHub renders Python notebooks as static html files. Therefore, the markdown text does not visualize correctly when viewing .ipynb notebooks on GitHub. You can either 
